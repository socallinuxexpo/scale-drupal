...
?>
<?php if (!empty($display_empty)): ?>
  <div class="room-schedule-empty">No sessions today</div>
<?php else: ?>
  ...
  <div id="multi-day-container">
    <table class="full">
      <tbody>
        ...
        <tr>
          <td class="rg1 <?php print $agenda_hour_class ?> first">
        ...
        <tr>
          <td class="rgf first">
            ...
            <?php foreach ($rows['items'] as $time_cnt => $hour): ?>
              ...
              <div class="rg2 <?php print $class?>calendar-agenda-hour">
          ...
          <td class="last">
            ...
            <div class="rg3 <?php print $class?>calendar-agenda-items single-day">
  ...
  <div class="rg5 single-day-footer">&nbsp;</div>
  </div></div>
  <?php if (!empty($scroll_content)) : ?>
  <script>
  try {
