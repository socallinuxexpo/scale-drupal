...
/**
 * If there is a chef settings file, then include it
 */
$chef_settings = $app_root . '/' . $site_path . "/settings.chef.php";
if (file_exists($chef_settings)) {
  include $chef_settings;
}

/**
 * If there is a local settings file, then include it
 */
$local_settings = $app_root . '/' . $site_path . "/settings.lando.php";
